...
![윈도우 64bit, 32bit, 리눅스 버전등 자신의 컴퓨터 시스템에 맞는 버전을 다운 받으면 된다.](/assets/images/OracleSQL/chap1/1.PNG){ :.aligncenter }<br/><br/>
...
![기업에서는 database 최고관리자만 이 비밀번호를 설정 해야한다.](/assets/images/OracleSQL/chap1/7.PNG){ :.aligncenter }<br/><br/>
...
![이곳이 C: 아래이다.](/assets/images/OracleSQL/chap1/3.PNG){ :.aligncenter }<br/><br/>
...
![관리자 권한 실행](/assets/images/OracleSQL/chap1/4.png){ :.aligncenter }<br/><br/>
